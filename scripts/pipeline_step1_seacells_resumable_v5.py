"""
Metacell Pipeline v1 (Resumable, Verbose, Robust) - v5 (Final)

This v5 script fixes a bug from v4 in the call to summarize_by_SEACell,
passing the column name instead of the data series. This should be the
...
# --- Ground Truth Marker Panel (17 Markers) ---
GROUND_TRUTH_MARKERS = sorted([
...
def process_single_sample(args_tuple):
    ...
    try:
        ...
        # Bug fix from v4: Add assignments to obs, then pass column name
...
def main():
    parser = argparse.ArgumentParser(description="Metacell Pipeline v5 (Final)")
    ...
    log_progress("Starting Metacell Pipeline v5 (Final)", args.log_resources)
