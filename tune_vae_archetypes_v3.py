"""
Hyperparameter tuning for VAE archetypes (v3 - Disambiguation Model)

This script runs a broad hyperparameter search for the Disambiguation VAE.
The objective function is designed to prioritize:
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="Broad Hyperparameter tuning for Disambiguation VAE (v3)")
    ...
    print("="*80 + "\nBROAD VAE HYPERPARAMETER TUNING (v3)\n" + "="*80)
    ...
    study = optuna.create_study(
        direction='minimize',
        study_name='disambiguation_vae_v3',
